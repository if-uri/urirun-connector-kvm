...
# code2llm | 29f 6212L | python:19,shell:3,yaml:3,toml:1,json:1,txt:1 | 2026-06-25
# generated in 0.01s
...
PIPELINES[200]:
  ...
  [22] Src [current]: current → _active_window
      PURITY: 100% pure
  [23] Src [page_ready]: page_ready → _evaluate → _pages → endpoint
      PURITY: 100% pure
  [24] Src [launch_session]: launch_session → start_session → endpoint
      PURITY: 100% pure
  [25] Src [find]: find → _run → _evaluate → _pages → ...(1 more)
      PURITY: 100% pure
  [26] Src [act]: act → _run → _evaluate → _pages → ...(1 more)
      PURITY: 100% pure
